...
public class MainWindowController {
    ...
    void initialize() throws IOException {
        ...
        currentProductMenuItem.setOnAction(event -> FormManager.setProductListPanel(mainPane));
        productTypeMenuItem.setOnAction(event -> FormManager.setProductTypeListPanel(mainPane));
    }
}